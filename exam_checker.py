...
scan_answer_paper_agent = ConversableAgent(
    ...
    system_message='''Your task is to see if the student has provided answers for each question. 
                      ...
                      Your response should contain the original message and a 'Data Check' field at the end, which says 'OK' 
                      if the student has provided answers to each question and if not, it says "NOT_OK". 
                      ''',
    llm_config = {"config_list" : config_list_gemini},
    human_input_mode = "NEVER",
)
